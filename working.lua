...
local loadedscript = game:HttpGet("https://raw.githubusercontent.com/saepojsekpi/tp/main/working.lua")
...
local function defTeleport(jobid)
    ...
    game:GetService("TeleportService"):Teleport(1537690962, game:GetService("Players").LocalPlayer)
    end)
